...
(function () {
  ...
  const RANDOM_MESSAGES = [
    { text: "No hay emociones buenas o malas: todas nos dicen algo.", grade: null, emotion: 'thinking' },
    { text: "Responde con sinceridad, no para quedar bien.", grade: null, emotion: 'love' },
    { text: "Si una pregunta te hace pensar... va funcionando 😌", grade: null, emotion: 'happy' },
    { text: "Respira. No hay prisa.", grade: null, emotion: 'neutral' },
    { text: "Conocerte también es aprender.", grade: null, emotion: 'happy' },
    { text: "Tus emociones cambian; tus habilidades también pueden crecer.", grade: null, emotion: 'love' },
    { text: "Piensa en cómo actúas normalmente, no solo hoy.", grade: null, emotion: 'thinking' },
    { text: "Tu resultado no es una etiqueta.", grade: null, emotion: 'neutral' },
    { text: "Una pausa también puede ser una buena respuesta ante el enojo.", grade: ["Octavo"], emotion: 'thinking' },
    { text: "Rigo también tiene días verdes, amarillos y rojos 😅", grade: ["Octavo"], emotion: 'dizzy' }
  ];
  ...
  const HINT_MESSAGES = [
    { text: "Piensa en lo que haces la mayoría de las veces.", grade: null, emotion: 'thinking' },
    { text: "Aquí no necesitas adivinar: solo ser sincero/a.", grade: null, emotion: 'love' },
    { text: "¿Dudas entre dos opciones? Elige la que ocurra con más frecuencia.", grade: null, emotion: 'confused' },
    { text: "No respondas lo que crees que el teacher quiere leer 👀", grade: ["Octavo"], emotion: 'sneaky' },
    { text: "Una emoción fuerte no te convierte en una mala persona.", grade: null, emotion: 'neutral' },
    { text: "Reconocer lo que sientes ya es una habilidad emocional.", grade: null, emotion: 'happy' },
    { text: "Pedir ayuda también cuenta como saber manejar una situación.", grade: null, emotion: 'love' },
    { text: "Entender a alguien no significa tener que pensar igual.", grade: null, emotion: 'thinking' },
    { text: "Antes de reaccionar: pausa, respira, piensa.", grade: null, emotion: 'neutral' },
    { text: "Tu zona amarilla no es fracaso; es zona de práctica.", grade: ["Octavo"], emotion: 'happy' }
  ];

  const CHEER_MESSAGES = [
    "Gracias por responder con sinceridad", "Vas muy bien", "Eso es: piensa en ti",
    "Seguimos con calma", "Cada respuesta te ayuda a conocerte"
  ];

  const COMFORT_MESSAGES = [
    "No pasa nada, puedes pensarlo otra vez",
    "Tómate tu tiempo",
    "No existe una respuesta perfecta aquí",
    "Respira y elige la opción más sincera"
  ];
  ...
  class RigoMascot extends HTMLElement {
    ...
    welcome() {
      ...
      this.say("¡Hola! Soy Rigo. Escribe tu NIE y descubramos juntos tu termómetro emocional 🌡️", 7000);
    }

    loginSuccess(name) {
      this.setEmotion('excited');
      const msg = name ? `¡Hola ${name}! Aquí no hay respuestas buenas ni malas. Sé tú mismo/a.` : "¡Bienvenido! Responde con sinceridad.";
      this.say(msg, 4000);
    ...
    inviteGame() {
      ...
      this.say("¿Listo/a para ver tu termómetro emocional? 🌡️", 5000);
    }
