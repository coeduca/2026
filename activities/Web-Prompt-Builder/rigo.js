...
(function () {
  ...
  const RANDOM_MESSAGES = [
    { text: "Tu progreso se guarda solito ✨", grade: null, emotion: 'happy' },
    { text: "Un buen prompt tiene buenos detalles", grade: null, emotion: 'thinking' },
    { text: "Tu foto irá junto al index como perfil.jpg", grade: null, emotion: 'sneaky' },
    { text: "GitHub Pages no muerde 😌", grade: null, emotion: 'happy' },
    { text: "Puedes elegir varios hobbies", grade: null, emotion: 'excited' },
    { text: "Cuando llegues al 100%, copia el prompt", grade: null, emotion: 'game' },
    { text: "No necesito tu NIE esta vez 😎", grade: null, emotion: 'sneaky' },
    { text: "Describe quién eres con tus propias palabras", grade: null, emotion: 'love' },
    { text: "Tu web va a quedar bien fachera", grade: null, emotion: 'excited' },
    { text: "HTML + CSS = magia legal", grade: null, emotion: 'musical' }
  ];
  ...
  const HINT_MESSAGES = [
    { text: "Pista: escribe datos reales sobre ti", grade: null, emotion: 'thinking' },
    { text: "Puedes tocar los hobbies para seleccionarlos", grade: null, emotion: 'sneaky' },
    { text: "No inventes una personalidad para impresionar a la IA 😭", grade: null, emotion: 'dizzy' },
    { text: "La foto debe llamarse perfil.jpg", grade: null, emotion: 'thinking' },
    { text: "Y va dentro de la carpeta fotos", grade: null, emotion: 'sneaky' },
    { text: "Mientras más claro escribas, mejor será tu página", grade: null, emotion: 'happy' },
    { text: "Tu prompt sale en inglés automáticamente", grade: null, emotion: 'excited' },
    { text: "No traduzcas nada. Yo hago esa parte 😌", grade: null, emotion: 'love' },
    { text: "¿Ya elegiste tus hobbies?", grade: null, emotion: 'confused' },
    { text: "Cuando veas 100%, dale a Copiar prompt", grade: null, emotion: 'game' },
    { text: "Séptimo también puede hacer una web brutal", grade: ["Séptimo"], emotion: 'excited' },
    { text: "Octavo, hoy somos desarrolladores 😎", grade: ["Octavo"], emotion: 'game' },
    { text: "Noveno: GitHub Pages arc desbloqueado", grade: ["Noveno"], emotion: 'sneaky' },
    { text: "Bachillerato: que ese About Me no parezca currículum de ministro", grade: ["Primer Año", "Segundo Año"], emotion: 'sneaky' }
  ];
  ...
  class RigoMascot extends HTMLElement {
    ...
    welcome() {
      ...
      this.say("¡Hola! Soy Rigo. Vamos a construir el prompt de tu página web 🦎", 7000);
    }

    loginSuccess(name) {
      this.setEmotion('excited');
      const msg = name ? `¡Hola ${name}! ¡Vamos a crear tu web!` : "¡Vamos a crear tu web!";
      this.say(msg, 4000);
    ...
    inviteGame() {
      ...
      this.say("¿Listo para convertir tu prompt en una web? 💻", 5000);
    }
