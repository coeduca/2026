...
(function () {
  ...
  const RANDOM_MESSAGES = [
    { text: "¡Hora de reflexionar!", grade: null, emotion: 'happy' },
    { text: "¡Tú puedes!", grade: null, emotion: 'excited' },
    { text: "¡Vamos por ese 10!", grade: null, emotion: 'love' },
    { text: "¡Sigue así, compañero!", grade: null, emotion: 'happy' },
    { text: "¡No te rindas!", grade: null, emotion: 'excited' },
    { text: "¡Confío en tu criterio!", grade: null, emotion: 'love' },
    { text: "Tus valores te definen", grade: null, emotion: 'thinking' },
    { text: "Conocer tus derechos es genial", grade: null, emotion: 'happy' },
    { text: "¡Buen análisis!", grade: null, emotion: 'excited' },
  ...
  const HINT_MESSAGES = [
    ...
    { text: "Hoy es un buen día para ser mejor ciudadano", grade: null, emotion: 'happy' },
    { text: "Seguro 10", grade: null, emotion: 'excited' },
    { text: "Ese libro es míiiiio 🎶", grade: null, emotion: 'musical' },
    { text: "No dudes tanto", grade: null, emotion: 'sneaky' },
    { text: "El libro de ciudadanía es tu mejor amigo hoy", grade: null, emotion: 'sad' },
    { text: "¿Necesitas ayuda?", grade: null, emotion: 'confused' },
    { text: "La respuesta está en tu corazón (y en el libro)", grade: null, emotion: 'love' },
    { text: "Deja de tocarme", grade: null, emotion: 'angry' },
    { text: "No te distraigas", grade: null, emotion: 'angry' },
    { text: "Solo me sé los derechos de los camaleones", grade: null, emotion: 'sad' },
    { text: "Necesito recreo ya!", grade: null, emotion: 'sad' },
    { text: "¿Todavía no has terminado?", grade: null, emotion: 'elder' },
    { text: "Es solo una actividad", grade: null, emotion: 'sneaky' },
    { text: "Predigo que serás un gran ciudadano", grade: null, emotion: 'excited' },
    { text: "Usa tu lógica y tu sentido común", grade: null, emotion: 'sneaky' },
    { text: "Ah! pero no fuera FreeFire", grade: null, emotion: 'angry' },
    { text: "Respira, esto acabará pronto", grade: null, emotion: 'neutral' },
    { text: "Lee muy bien antes de contestar", grade: null, emotion: 'love' },
    { text: "Yo solo soy un camaleón, no la Ministra de Educación", grade: null, emotion: 'sad' },
    { text: "Lo siento, la ética no se copia", grade: null, emotion: 'sad' },
    { text: "Recuerda: la dignidad humana es inalienable", grade: null, emotion: 'sneaky' },
  ...
  const CHEER_MESSAGES = [
    "¡Esoooo!", "¡Así se hace!", "¡Genial!", "¡Perfecto!",
